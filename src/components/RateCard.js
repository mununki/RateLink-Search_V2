...
class RateCard extends Component {
  constructor(props) {
    ...
    this._hideSwipe = this._hideSwipe.bind(this);
      ...
      return (
        <DivContainer>
          <DivHeader isSwipe={isSwipe}>
            ...
            >
              {rate.inputperson.profile.profileName}
            </DivHeaderInputperson>
            <DivHeaderAccount>{rate.account.name}</DivHeaderAccount>
            <DivHeaderLiner>
              <img
                src={
                  DOMAIN_STATIC +
                  "/countrycity/liners_image/" +
                  `${rate.liner.name}` +
                  ".png"
                }
                width="70px"
            ...
            <DivHeaderType>{rate.type.name}</DivHeaderType>
            <DivHeaderBS>
              <DivHeaderBSType>
                <DivHeaderBSType20>
                  {rate.buying20
            ...
            <DivHeaderOD>{rate.offeredDate.slice(5)}</DivHeaderOD>
            <DivHeaderED>{rate.effectiveDate.slice(5)}</DivHeaderED>
            <DivHeaderRMK>
              {rate.remark ? (
                <Fragment>
                  <i
